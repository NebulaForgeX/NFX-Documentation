...
Pin **nfx-ui 0.28.0**. Chrome is local `DocsLayout` + `@radix-ui/themes` + lucide (do not import missing `nfx-ui/layouts`).
...
Every NFX product repo (Stack, Edge, Vault, Identity, UI, News, Storages, this repo):
