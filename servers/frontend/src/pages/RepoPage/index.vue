    ...
    <div :class="styles.repoList">
      ...
      >
        <div :class="styles.repoHeader">
          <svg :class="styles.repoIcon" fill="currentColor" viewBox="0 0 24 24">
          ...
          <h3 :class="styles.repoTitle">{{ repo.name }}</h3>
        </div>
...
const repos = computed(() => [
  {
    name: 'NFX-Stack',
    description: t('repo.nfxStack.description'),
    url: 'https://github.com/NebulaForgeX/NFX-Stack',
    language: 'Docker Compose',
  },
  {
    name: 'NFX-Edge',
    description: t('repo.nfxEdge.description'),
    url: 'https://github.com/NebulaForgeX/NFX-Edge',
    language: 'Docker Compose',
  },
  {
    name: 'NFX-Vault',
    description: t('repo.nfxVault.description'),
